...
import { Loader2, ShieldCheck, ExternalLink, Search, Globe, CheckCircle2 } from "lucide-react";
...
const Insurance = () => {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden flex flex-col">
            <SEO
                title="Car Insurance Partners - OneStop Application Services"
                description="Compare and connect with our trusted car insurance partners."
            />
            <AnimatedBackground />
            <Navbar />
            ...
            <main className="flex-1 container mx-auto px-4 py-12 relative z-10">
                <div className="text-center mb-16 space-y-4">
                    ...
                    >
                        Find the right protection for your vehicle. Explore our network of reliable insurance providers to get the best coverage and rates.
                    </motion.p>
                </div>
                ...
                {loading ? (
                    ...
                    >
                        ...
                        <p className="text-muted-foreground max-w-md mx-auto">
                            We couldn't find any insurance providers matching your search. Please try adjusting your filters.
                        </p>
                        {searchTerm && (
